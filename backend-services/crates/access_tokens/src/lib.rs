...
use oclink_contracts::access_tokens::v1::access_tokens_service_server::AccessTokensService;
use oclink_contracts::access_tokens::v1::{
...
use oclink_contracts::auth::v1::AuthenticateRequest;
...
pub struct OcLinkAccessTokens {
    jwt_manager: Arc<JwtManager>,
    auth_client: AuthServiceClient<Channel>,
}

impl OcLinkAccessTokens {
...
#[tonic::async_trait]
impl AccessTokensService for OcLinkAccessTokens {
    ...
    async fn issue_token(
        ...
        let claims = Claims {
            ...
            sid: sid.clone(),
            iss: "oclink_access_tokens".to_string(),
